...
def main(args):
    print("parameters: \n0 -> pathIn \n1 -> pathInCities \n2 -> pathOut ")
    pathIN,pathInCities, pathOut = args[0],args[1],args[2]
    fractalDim = []
    patterns = ["holes", "mazes", "solitons", "movingSpots","cities"]
    dic = {}
    ...
    plt.hist(vals,  bins=10,density=True, cumulative=False, stacked=False, label=patterns , color=colors)
